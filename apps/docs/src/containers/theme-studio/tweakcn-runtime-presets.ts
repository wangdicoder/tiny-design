export interface TweakcnRuntimePresetSource {
  id: string;
  label: string;
  createdAt?: string;
  styles: Record<'light' | 'dark', Record<string, string>>;
}

export const TWEAKCN_RUNTIME_PRESET_SOURCES: TweakcnRuntimePresetSource[] = [
  {
    "id": "default",
    "label": "Default",
    "styles": {
      "light": {
        ...
        "card": "#ffffff",
        "card-foreground": "rgba(0, 0, 0, 0.85)",
        "popover": "#ffffff",
        "popover-foreground": "rgba(0, 0, 0, 0.85)",
        "primary": "#6e41bf",
        "primary-foreground": "#ffffff",
        "secondary": "#f5f5f5",
        "secondary-foreground": "#32325d",
        "muted": "#fafafa",
        "muted-foreground": "rgba(0, 0, 0, 0.45)",
        "accent": "#f3eefa",
        "accent-foreground": "#6e41bf",
        "success": "#52c41a",
        ...
        "sidebar-accent": "#f3eefa",
        "sidebar-accent-foreground": "#6e41bf",
      ...
      "dark": {
        ...
        "sidebar-primary-foreground": "#ffffff",
        "sidebar-accent": "#1a1325",
        "sidebar-accent-foreground": "#9065d0",
