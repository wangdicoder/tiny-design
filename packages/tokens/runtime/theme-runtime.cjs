...
const registry = require('../dist/registry.json');

function loadPresets() {
  try {
    return require('../dist/presets.json');
  } catch {
    return {
      'tiny-light': require('../source/themes/light.json'),
      'tiny-dark': require('../source/themes/dark.json'),
    };
  }
}

const defaultPresets = loadPresets();
